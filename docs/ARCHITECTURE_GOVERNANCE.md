...
Expert-to-expert and expert-to-Architect notifications must stay short and point back to GitHub/files as the source of truth. See `docs/EXPERT_COMMUNICATION_PROTOCOL.md`.
