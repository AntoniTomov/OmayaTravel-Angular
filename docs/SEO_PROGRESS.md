...
| M   | **Performance — baseline and first changes implemented**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Five production lab audits, twelve smaller image encodings and the critical-path font work are recorded in `SEO_PHASE_5_PERFORMANCE.md`. Latest: removed a preload that fetched an unused stylesheet on every page, and replaced the 128,352-byte hosted Material Icons font with a self-hosted 2,688-byte subset. Listing forced reflow is still unattributed; post-release comparison and field data remain. Font-swap hypothesis is still unproven — Roboto and Kristi are unchanged and still third-party. |
