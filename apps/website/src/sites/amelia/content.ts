    ...
    items: [
      {
        ...
        description:
          'Пътуваме в малки групи (до 16 души) от жени пътешественички на възраст 20-65 г. Защото знаем, че най-хубавите спомени се създават не само от местата, които посещаваш, но и от хората, с които ги споделяш. Затова предлагаме всяко пътуване в две дати - за групи 20-45 г. и 40-65 г., за да пътуваш с жени на сходна възраст и в сходен етап от живота.',
      },
      {
