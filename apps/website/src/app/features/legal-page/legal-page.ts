...
const AMELIA_TERMS_SECTIONS: readonly LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'За да бъде потвърдена резервацията, е необходим депозит. Обичайно депозитът е в размер на 25% на човек и се дължи в срок от седем (7) дни от писменото потвърждение, освен ако не е посочено друго. За някои организирани пътувания може да се изисква по-висок депозит, което ще бъде ясно посочено в условията на съответната страница на пътуването.',
      ...
      'Пълното плащане трябва да бъде получено не по-късно от 60 дни преди началото на пътуването, освен ако не е посочено друго. Някои организирани пътувания може да изискват по-ранно плащане или допълнителни вноски, за което ще бъдете уведомени при потвърждението на резервацията.',
  ...
  },
  {
    ...
    list: [
      'По-малко от 14 дни преди отпътуване: сумата не подлежи на възстановяване.',
      '45–30 дни преди отпътуване: пълно възстановяване на платената сума, с изключение на депозита.',
      '29–15 дни преди отпътуване: възстановяват се 30% от платената сума.',
    ],
  },
  {
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Ако пътуването вече е започнало, ще окажем разумно съдействие за организиране на алтернативно пътуване или за продължаване на тура за Ваша сметка, доколкото това е възможно. Ако пътуването не е започнало, съдействие не може да бъде предоставено. В тези случаи разходите, които вече са направени към доставчици и не подлежат на възстановяване, могат да бъдат за сметка на пътника. Amelia Travel не носи отговорност за други загуби, включително разходи за самолетни билети или визи, освен когато приложимото законодателство предвижда друго.',
      'Силно препоръчваме сключването на подходяща туристическа застраховка за допълнителни рискове, които не са покрити от застраховката, предоставена от Amelia Travel.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'В случаите, когато Amelia Travel е длъжна да възстанови суми съгласно приложимото законодателство, това ще бъде извършено в съответствие с приложимите законови срокове.',
    ],
  },
  {
    heading: '7. Промени',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Съществуващи медицински състояния, които увеличават риска или могат да повлияят на пътуването, трябва да бъдат разкрити при резервацията. Amelia Travel може да поиска медицинска оценка, когато това е необходимо и допустимо съгласно приложимото законодателство.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Съквартирантите се подбират единствено според пола, без гаранция за съвместимост. Amelia Travel не носи отговорност за евентуални неудобства, причинени от съквартиранти, освен когато произтичат от неизпълнение на задълженията на Amelia Travel по договора или закона.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'Някои организирани пътувания изискват минимален брой участници, който ще бъде посочен в информацията за съответното пътуване и/или договора.',
      'Ако минималният брой не бъде достигнат, Amelia Travel може да анулира пътуването при условията и в сроковете, предвидени в приложимото законодателство, като пътуващият ще бъде уведомен не по-късно от 45 дни преди отпътуване.',
      ...
      'Amelia Travel не носи отговорност за допълнителни разходи, като отделно закупени самолетни билети, когато това е допустимо съгласно приложимото законодателство.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Тази клауза не ограничава отговорността на Amelia Travel, когато такава е предвидена в приложимото законодателство.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Тази клауза не ограничава отговорността на Amelia Travel в случаите, предвидени в приложимото законодателство.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Пътуващият трябва да предостави разумна възможност на Amelia Travel да отстрани възникналото несъответствие.',
  ...
  },
  {
    ...
    paragraphs: [
      'По време на организираните пътувания Amelia Travel може да прави снимки или видеозаписи.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Amelia Travel не носи отговорност за повреден или изгубен багаж, освен когато отговорността произтича от приложимото законодателство или от действия/бездействия на Amelia Travel.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Amelia Travel не носи отговорност за проблеми, възникнали на границата вследствие на притежание или пренасяне на предмети от страна на пътуващия.',
    ],
  },
  {
...
const AMELIA_COOKIE_POLICY_SECTIONS: readonly LegalSection[] = [
  ...
  },
  {
    ...
    list: [
      ...
      'запомняме избраните от Вас туристически пакети по време на процеса на резервация;',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Тези бисквитки ни позволяват да запомняме избраните от Вас туристически пакети и въведените данни по време на процеса на резервация, за да Ви предоставим по-удобно и последователно изживяване на сайта.',
...
const AMELIA_PRIVACY_POLICY_SECTIONS: readonly LegalSection[] = [
  {
    heading: '1. Въведение',
    paragraphs: [
      'Ние зачитаме Вашата поверителност и сме ангажирани със защитата на Вашите лични данни.',
      'Настоящата Политика за поверителност обяснява как събираме, използваме и защитаваме Вашата информация, когато посещавате нашия уебсайт или резервирате някое от нашите пътувания в малки групи.',
      'Amelia Travel („Амелия“) е подбранд на „Омая Травел“ ЕООД, ЕИК 208663654, регистрирано като туроператор и туристически агент с удостоверение за регистрация № РК-01-8706.',
      'Когато използвате уебсайта на Amelia Travel, резервациите и договорите за туристически пакети се сключват с „Омая Травел“ ЕООД, което е юридическият туроператор и носи отговорност за предоставяните туристически услуги. „Омая Травел“ ЕООД е администраторът на лични данни, отговорен за Вашите лични данни.',
    ],
  },
  {
    heading: '2. Каква информация събираме',
    paragraphs: ['Може да събираме следните видове лични данни:'],
    list: [
      'Данни за самоличност: име, фамилия',
      'Данни за контакт: имейл адрес, телефонен номер',
      'Информация за резервацията: предпочитания за тура, дати на пътуване, специални изисквания',
      'Платежна информация: данни за фактуриране (обработвани сигурно чрез доставчици — трети страни)',
      'Технически данни: IP адрес, тип браузър, информация за устройството',
      'Данни за използване: посетени страници, време, прекарано на нашия уебсайт',
    ],
  },
  {
    paragraphs: [
      'Освен това автоматично събираме определена информация чрез бисквитки и подобни технологии. За повече подробности, моля, вижте нашата Политика за бисквитките.',
    ],
  },
  {
    heading: '3. Как използваме Вашите данни',
    paragraphs: ['Използваме Вашите лични данни, за да:'],
    list: [
      'обработваме и управляваме Вашите резервации;',
      'комуникираме с Вас относно Вашите пътувания;',
      'предоставяме клиентска поддръжка;',
      'подобряваме нашия уебсайт и услуги;',
      'изпращаме маркетингови съобщения (само с Вашето съгласие);',
      'спазваме законови задължения.',
    ],
  },
  {
    paragraphs: [
      'Използваме също бисквитки и подобни технологии, за да анализираме трафика на уебсайта, персонализираме съдържанието и подобряваме потребителското изживяване.',
    ],
  },
  {
    heading: '4. Правно основание за обработка (ОРЗД)',
    paragraphs: [
      'Обработваме Вашите данни съгласно Общия регламент относно защитата на данните (ОРЗД/GDPR) въз основа на:',
    ],
    list: [
      'Договор: за изпълнение на Вашата резервация',
      'Съгласие: за маркетингови съобщения, бисквитки и технологии за проследяване',
      'Законово задължение: за счетоводни и регулаторни цели',
      'Легитимен интерес: за подобряване на нашите услуги и уебсайт',
    ],
  },
  {
    heading: '5. Услуги на трети страни',
    paragraphs: [
      'Използваме доверени услуги на трети страни за управление на бизнеса ни и подобряване на нашите услуги, включително:',
    ],
    list: [
      'Google Analytics – за да разберем как посетителите използват нашия уебсайт',
      'Meta Platforms, Inc. (Meta Ads / Facebook Pixel) – за измерване и оптимизиране на рекламни кампании',
      'Доставчици на имейл маркетинг (напр. Mailchimp или подобни) – за изпращане на бюлетини и новини',
    ],
  },
  {
    paragraphs: [
      'Тези доставчици могат да обработват Вашите данни от наше име и могат да използват бисквитки или подобни технологии.',
    ],
  },
  {
    ...
    list: [
      ...
      'туристически водачи и местни партньори (само когато е необходимо за Вашето пътуване);',
      'доставчици на ИТ и уебсайт услуги;',
      'партньори за анализ и реклама (с Вашето съгласие);',
      'правни или регулаторни органи, когато се изисква по закон.',
    ],
  },
  {
    paragraphs: ['Ние никога не продаваме Вашите лични данни.'],
  },
  {
    heading: '7. Международни трансфери',
    paragraphs: [
      'Някои от нашите доставчици — трети страни (като Google и Meta) — може да прехвърлят Вашите данни извън Европейското икономическо пространство (ЕИП).',
      'В такива случаи гарантираме, че са въведени подходящи гаранции, включително използването на Стандартни договорни клаузи, одобрени от Европейската комисия.',
    ],
  },
  {
    heading: '8. Съхранение на данните',
    paragraphs: ['Съхраняваме Вашите лични данни само толкова дълго, колкото е необходимо:'],
    list: [
      'записи за резервации и финансови документи: до 5–7 години (за спазване на законови и данъчни задължения);',
      'маркетингови данни: до оттегляне на Вашето съгласие или отписване;',
      'данни за анализ и бисквитки: съгласно нашата Политика за бисквитките.',
    ],
  },
  {
    heading: '9. Вашите права',
    paragraphs: ['Съгласно Общия регламент относно защитата на данните (ОРЗД), имате право на:'],
    list: [
      'достъп до Вашите лични данни;',
      'коригиране на неточни данни;',
      'заявяване на изтриване ("право да бъдете забравени");',
      'ограничаване или възражение срещу обработката;',
      'преносимост на данните;',
      'оттегляне на съгласието по всяко време (включително за маркетинг и бисквитки).',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'Прилагаме подходящи технически и организационни мерки за защита на Вашите данни от неоторизиран достъп, загуба или злоупотреба.',
    ],
  },
  {
    heading: '11. Връзки към трети страни',
    paragraphs: [
      'Нашият уебсайт може да съдържа връзки към други уебсайтове. Ние не носим отговорност за практиките им за поверителност.',
    ],
  },
  {
    heading: '12. Поверителност на децата',
    paragraphs: [
      'Нашите услуги са предназначени за лица на възраст 16 и повече години.',
      'Може да събираме и обработваме лични данни на лица на възраст 16–17 години с цел резервация и участие в нашите пътувания. Когато се изисква, може да поискаме съгласие от родител или законен настойник.',
      'Ние съзнателно не събираме лични данни от лица под 16-годишна възраст. Ако установим, че сме събрали такива данни, ще предприемем стъпки за тяхното изтриване.',
      'Ако смятате, че дете под 16 години ни е предоставило лични данни, моля, свържете се с нас.',
    ],
  },
  {
    heading: '13. Актуализации на настоящата политика',
    paragraphs: [
      'Може да актуализираме тази Политика за поверителност периодично. Промените ще бъдат публикувани на тази страница.',
    ],
  },
  {
    heading: '14. Свържете се с нас',
    paragraphs: [
      'Ако имате въпроси относно тази Политика за поверителност или Вашите данни, моля, свържете се с нас:',
...
const AMELIA_LEGAL_PAGES: Partial<Record<string, LegalPageContent>> = {
  ...
  'privacy-policy': {
    ...
    heroImage: '/assets/images/legal/privacy-policy.webp',
    sections: AMELIA_PRIVACY_POLICY_SECTIONS,
  },
  'omaya-travel-license': {
