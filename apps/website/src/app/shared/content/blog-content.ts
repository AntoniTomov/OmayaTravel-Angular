...
const AMELIA_MOROCCO_POST_IMAGE_BASE = '/assets/images/amelia/blog/morocco-for-women-travel-guide';
const AMELIA_INDIA_BLOG_IMAGE_BASE = '/assets/images/amelia/blog/india-otblizo';
...
export const MAROKO_ZA_ZHENI_PATESHESTVENICHKI: BlogPostContent = {
  ...
  sections: [
    {
      text: [
        'Има пътувания, които започват още с кацането. Мароко е точно такова.',
        'Още в първите часове сетивата се включват на максимум - ароматът на мента и подправки, шумът на улиците, цветовете на пазарите, тесните улички на медината, гласовете около теб. Всичко се случва едновременно и постепенно разбираш, че си попаднала в среда с различен ритъм от този, с който си свикнала.',
        'А когато пътуваш като жена, идват и други въпроси. Безопасно ли е? Как да се обличаш? Какво е прието и какво не? Ето какво е добре да знаеш.',
      ],
      image: {
        src: `${AMELIA_MOROCCO_POST_IMAGE_BASE}/morocco-1.avif`,
        alt: 'Пъстри улици и детайли от Мароко',
      },
    },
    {
      title: 'Безопасно ли е Мароко за жени?',
      text: [
        'Това е един от най-честите въпроси и краткият отговор е: да, когато знаеш какво да очакваш.',
        'Мароко е утвърдена туристическа дестинация, но това, с което най-често можеш да се сблъскаш, е по-скоро досадно, отколкото опасно: настойчиви търговци, хора, които предлагат да те заведат до определено място, или нежелано внимание по улицата.',
        'Няколко малки неща могат да направят разликата:',
      ],
      boldList: [
        {
          label: 'Ясното „не“ работи.',
          text: ' Кратко и спокойно, без да е необходимо да обясняваш. „Ла, шукран“ („не, благодаря“) обикновено е достатъчно.',
        },
        {
          label: 'Не приемай непоискана помощ с посоката.',
          text: ' В медините на Маракеш и Фес някой може да предложи да те заведе до мястото, което търсиш, а след това да поиска пари. Ако се загубиш, по-добре влез в магазин или кафене и попитай там.',
        },
        {
          label: 'Такситата.',
          text: ' В градовете малките таксита, познати като „petit taxi“, обикновено работят с таксиметров апарат. Увери се, че е включен, или уговори цената предварително, ако това е обичайната практика на мястото.',
        },
        {
          label: 'Вечер.',
          text: ' Главните улици и площадите остават оживени до късно и това е напълно нормално. Тесните и неосветени улички на медината обаче не са място, в което е разумно да се разхождаш сама късно вечер.',
        },
        {
          label: 'Снимките.',
          text: ' Не снимай хора без разрешение. На площад Джемаа ел-Фна в Маракеш например уличните изпълнители и жените, които правят рисунки с къна, могат да очакват заплащане, ако ги снимаш.',
        },
        {
          label: 'Настаняването.',
          text: ' Риадите - традиционните къщи с вътрешен двор - често се намират в самото сърце на медината, където автомобилите не могат да стигнат до входа. Това може да изглежда неудобно в началото, но собствениците обикновено познават района и могат да организират посрещането ти.',
        },
      ],
    },
    {
      text: [
        'И още нещо важно: отделните неприятни ситуации не са характеристика на цяла страна. Мароко е много повече от впечатлението, което може да остави един шумен пазар.',
      ],
    },
    {
      title: 'Как да се обличаш в Мароко?',
      text: [
        'Мароко е по-разнообразно и либерално, отколкото често си представяме. Туристките не са очаквани да носят забрадка, а в Маракеш и по крайбрежието ще видиш жени с най-различен стил на обличане.',
        'Практичното правило е да избираш дрехи с покрити рамене и колене, особено извън туристическите зони, в по-малките населени места и при посещение на религиозни места. Не толкова заради конкретна забрана, колкото защото така по-лесно се вписваш в средата и избягваш излишното внимание.',
        'Какво работи най-добре:',
      ],
      list: [
        'широки панталони или дълги поли от лек памук или лен;',
        'тениски и ризи с ръкав вместо потници;',
        'голям шал - полезен за раменете, слънцето и праха в пустинята;',
        'удобни затворени обувки - настилката в медините често е неравна, а Шефшауен е разположен по стръмен склон;',
        'топъл слой за пустинята и планината - температурите между деня и нощта могат да се различават значително.',
      ],
      image: {
        src: `${AMELIA_MOROCCO_POST_IMAGE_BASE}/morocco-3.avif`,
        alt: 'Детайли от мароканска медина',
      },
    },
    {
      title: 'Кога е най-доброто време за пътуване до Мароко?',
      text: [
        'Пролетта (март-май) и есента (септември-ноември) обикновено са най-приятните сезони за пътуване. Дните са топли, но температурите са по-поносими, особено ако маршрутът включва вътрешността на страната и пустинята.',
        'Лятото може да бъде много горещо във вътрешността. В Маракеш и Фес температурите през юли и август често надхвърлят 40°C, а в пустинята условията са още по-сурови. Зимата е приятна в много от градовете, но нощите в пустинята могат да бъдат студени, а в Атласките планини има сняг.',
        'Ако пътуването ти съвпадне с Рамадан, ритъмът на страната се променя. Част от заведенията работят с различно време през деня, а вечер градовете оживяват след залез. Това не е пречка за пътуване, но е нещо, което е добре да имаш предвид при планирането. Датите на Рамадан се променят всяка година.',
      ],
    },
    {
      title: 'Жените, ежедневието и културните срещи',
      text: [
        'Една от най-интересните части на пътуването е да видиш ежедневието през историите на жените, които живеят и работят в страната.',
        'В районите, където се отглежда арган, можеш да посетиш женски кооперативи и да видиш как се произвежда аргановото масло. За много от жените тези кооперативи са възможност за собствен доход и професионална независимост.',
        'Във Фес традиционните квартални фурни са част от ежедневието на медината. Семействата носят тестото си, за да бъде изпечено в общата пещ, а фурната е не просто място за хляб, а част от живота на квартала.',
        'Тъкачеството в Средния Атлас е занаят, който в много общности се предава през поколенията. Мотивите и техниките в текстила често носят информация за произхода и традициите на семейството.',
        'А хамамът е едно от местата, където жените имат свое пространство за общуване и грижа за себе си. Той е много повече от спа процедура - за много хора е социален ритуал и част от ежедневието.',
        'Понякога разговорът с една жена, дори без общ език, оставя по-силен спомен от поредната забележителност.',
      ],
      image: {
        src: `${AMELIA_MOROCCO_POST_IMAGE_BASE}/morocco-4.avif`,
        alt: 'Марокански цветове, текстури и занаяти',
      },
    },
    {
      title: 'Пустинята и моментите на тишина',
      text: [
        'След шумните улици и пазарите пустинята носи съвсем различно усещане.',
        'Хоризонтът е огромен, пространството сякаш няма край. Денят постепенно притихва, а след залеза небето започва да изглежда по-близо.',
        'Тогава и разговорите стават по-тихи. Може би заради мястото, а може би защото след няколко дни, пълни с нови впечатления, най-накрая имаш време просто да бъдеш.',
        'Точно такива моменти често остават най-дълго.',
      ],
    },
    {
      title: 'Какво означава да пътуваш с други жени?',
      text: [
        'Може би означава да оставиш за известно време обичайния си ритъм и да си дадеш възможност за нещо ново.',
        'Да оставиш телефона, да прекараш ден без график, да разговаряш с жена, която вероятно никога повече няма да срещнеш. Да гледаш залеза над дюните и да седнеш на маса с жени, които допреди няколко дни не познаваш, а сега споделяте истории и се смеете заедно.',
        'И да си позволиш за известно време да не бъдеш нито професионалист, нито майка, нито партньор, нито човекът, който организира всичко. Да не мислиш за следващата задача, следващото съобщение или следващото „трябва“.',
        'Просто да бъдеш там.',
      ],
    },
    {
      title: 'Защо да избереш малка женска група?',
      text: [
        'Да пътуваш сама до Мароко е напълно възможно. Да го преживееш в компанията на други жени обаче е съвсем различно усещане.',
        'Когато пътуваш в малка женска група, не мислиш постоянно за следващата спирка, транспорта или вечерните планове. Освобождава се нещо по-ценно - време да преживееш Мароко, вместо непрекъснато да го организираш.',
        'Има и още нещо - местната жена гид ти помага да видиш страната отвъд забележителностите. Срещите с други жени, посещенията в работилници и кухни и разговорите за ежедневието дават на пътуването съвсем друг контекст.',
      ],
    },
    {
      cta: {
        before:
          'Amelia е първият български travel бранд, създаден изцяло за жени пътешественички. Създадохме го за онези моменти, в които ти се иска да тръгнеш, дори когато няма с кого. Нашето пътуване до Мароко е в малка женска група, водена от местна жена гид и човек от нашия екип - с време да видим не само местата, но и живота около тях. ',
        linkText: 'Разгледай пътуването до Мароко с Amelia',
  ...
  sections: [
    {
      text: [
        'В сърцето на Киргизстан, на 3016 метра надморска височина, ще откриете Сонг-Кул – езеро, което пази духа на номадския живот. Тук времето тече по различен ритъм, а безкрайните пасища и величествените планини създават усещане за пълна свобода.',
        'Тук няма градове, асфалтови пътища или постоянни селища. Има само зелени пасища, стада коне, разпръснати юрти и хора, които все още следват сезонния ритъм на номадския живот.',
        'Сонг-Кул е от онези места, които не просто разглеждате – преживявате ги. И може би именно тук разбирате колко рядко в ежедневието си всъщност усещаме истинската свобода.',
        'За много пътуващи Сонг-Кул е един от акцентите на Киргизстан. А ако искате да го включите в своето пътуване, ето какво е добре да знаете предварително.',
      ],
      image: {
        src: `${KYRGYZSTAN_POST_IMAGE_BASE}/Kyrgyzstan-tour-img-1.webp`,
        alt: 'Юрти и открити пасища около Сонг-Кул',
    ...
    {
      title: 'Къде се намира Сонг-Кул?',
      text: [
        'Сонг-Кул (Song-Kul) е второто по големина езеро в Киргизстан и се намира в района на Нарин, високо в планината Тян Шан.',
        'Езерото е дълго около 29 км и се намира на 3016 метра надморска височина. През зимата замръзва напълно, а районът е покрит със сняг и остава недостъпен за туристически посещения за няколко месеца.',
        'През лятото обаче всичко се променя. Високото плато около езерото се превръща в жайлоо – традиционните летни пасища на киргизките номади. Тук пастирските семейства прекарват летните месеци в юрти, заедно със своите коне, овце и други животни, преди с настъпването на есента да се върнат обратно към долините.',
        'Именно това прави Сонг-Кул толкова различен. Тук не просто наблюдавате номадския начин на живот – за няколко дни се потапяте в самия му ритъм.',
      ],
      image: {
        src: `${KYRGYZSTAN_POST_IMAGE_BASE}/Kyrgyzstan-SongKul-Lake-img-2.webp`,
        alt: 'Езерото Сонг-Кул в Киргизстан',
      },
    },
    {
      title: 'Кога е най-добре да посетите Сонг-Кул?',
      text: [
        'Сезонът за посещение на Сонг-Кул е кратък – от юни до септември. През останалата част от годината снегът прави планинските пътища труднопроходими или напълно недостъпни.',
        'Юли и август са най-популярните месеци. Тогава времето обикновено е най-благоприятно, юртените лагери са в разгара на сезона, а номадските семейства са на пасищата.',
        'Юни е прекрасен избор, ако искате да видите пасищата в наситено зелено и да избегнете част от туристите. Но нощите могат да бъдат много студени.',
        'Септември е по-тих, а светлината вече има онзи златист оттенък на края на лятото. Към средата на месеца някои лагери започват да затварят.',
        'И едно важно правило: не се доверявайте твърде много на прогнозата за времето. В планината условията могат да се променят за часове. Слънчевото утро може да бъде последвано от дъжд, силен вятър или градушка. Дори през август си носете топли дрехи.',
      ],
      image: {
        src: `${KYRGYZSTAN_POST_IMAGE_BASE}/Kyrgyzstan-SongKul-Lake-img-3.webp`,
        alt: 'Езерото Сонг-Кул през летния сезон',
      },
    },
    {
      title: 'Как се стига до Сонг-Кул?',
      text: [
        'Най-често пътуващите стигат до езерото през Кочкор или от района на Нарин. От Кочкор до Сонг-Кул пътят отнема приблизително 3–4 часа с 4x4 автомобил, но това не е обикновено планинско шосе – има стръмни, неасфалтирани и доста неравни участъци.',
      ],
      boldList: [
        {
          label: 'С автомобил.',
          text: ' Най-удобният вариант е да организирате автомобил с шофьор или 4x4 транспорт. Ако пътувате самостоятелно, местните организации за Community Based Tourism (CBT) в Кочкор и Нарин могат да помогнат с транспорт и настаняване.',
        },
        {
          label: 'На кон.',
          text: ' Ако искате самото пътуване до Сонг-Кул да бъде част от приключението, конният преход е един от най-хубавите варианти. От Кочкор или Кизарт има многодневни маршрути през планинските проходи и жайлоо. Това е и начинът, по който пейзажът се усеща най-пълно – бавно, без нищо между вас и планината.',
        },
        {
          label: 'Пеша.',
          text: ' За по-опитните планинари има и няколкодневни преходи към езерото. Един от популярните маршрути започва от Кизарт и преминава през високопланински пасища и проходи.',
        },
      ],
      image: {
        src: `${KYRGYZSTAN_POST_IMAGE_BASE}/Kyrgyzstan-SongKul-Lake-img-4.webp`,
        alt: 'Път към езерото Сонг-Кул',
      },
    },
    {
      text: [
        'Важно: не разчитайте на обикновен лек автомобил. Пътищата към Сонг-Кул са груби и неасфалтирани, а 4x4 автомобилът е най-сигурният избор.',
      ],
    },
    {
      title: 'Къде се спи на Сонг-Кул?',
      text: [
        'Тук няма хотели в традиционния смисъл на думата.',
        'Вместо тях по време на летния сезон около езерото се появяват юртените лагери, много от които са свързани с местни семейства и общности. Те са временни – появяват се с идването на номадските семейства и изчезват отново с края на сезона.',
        'Условията са семпли. Обикновено се спи в традиционна юрта върху дюшеци и одеяла, санитарните помещения са споделени, а електричеството и течащата топла вода не са даденост.',
        'Някои лагери са по-организирани и предлагат повече удобства, но като цяло не идвате на Сонг-Кул заради комфорта. И точно това е част от преживяването.',
        'Цените варират според лагера и условията, но ориентировъчно нощувка в традиционна юрта може да бъде около 15–40 USD на човек, като често са включени закуска и вечеря.',
        'Храната обикновено е домашна и семпла – хляб, чай, супа, ориз и местни ястия с месо. Ако имате хранителни ограничения или алергии, най-добре е да предупредите предварително.',
      ],
    },
    {
      title: 'Какво да правите на Сонг-Кул?',
      text: [
        'Честният отговор е: не много. И точно това е идеята.',
        'Сонг-Кул не е място, което трябва да бъде запълнено с активности от сутрин до вечер. Тук най-хубавото е да забавите темпото – да седите край езерото, да гледате как конете пасат, да разговаряте с хората от юртите, да яздите без конкретна цел и просто да оставите деня да мине.',
      ],
      boldList: [
        {
          label: 'Яздене.',
          text: ' Конят е естественият начин да разгледате района. Можете да яздите покрай езерото, през пасищата или да се отправите на по-дълъг конен преход. А да яздите по залез, когато светлината се разлива върху водата, а планините около езерото започват да придобиват розов оттенък, е един от онези моменти, които не се нуждаят от филтър.',
        },
        {
          label: 'Разходки и преходи.',
          text: ' Около езерото има възможности за по-кратки разходки и многодневни преходи. Пейзажът е открит и огромен – зелени пасища, планини и вода, докъдето стига погледът. А когато се изкачите малко над брега, гледката към Сонг-Кул се разгръща пред вас по начин, който трудно се улавя на снимка.',
        },
        {
          label: 'Наблюдение на звездите.',
          text: ' Едно от най-хубавите неща на Сонг-Кул започва след залез. Тук няма градски светлини и нощното небе е невероятно ясно. При подходящо време Млечният път се вижда над платото, а езерото се превръща в тъмно огледало. Това е моментът, в който разбирате колко малко всъщност ви е необходимо, за да се почувствате далеч от всичко.',
        },
      ],
    },
    {
      title: 'Няколко неща, които е добре да знаете предварително',
      text: ['Сонг-Кул е красиво място, но не е за всеки. Преди да тръгнете, имайте предвид:'],
      list: [
        'Няма банкомати, затова носете достатъчно киргизки соми в брой.',
        'Не разчитайте на мобилен сигнал или Wi-Fi. Това е част от изолацията на мястото.',
        'Нощите могат да бъдат много студени, дори през лятото. Вземете топли слоеве дрехи и не разчитайте, че печката в юртата ще работи цяла нощ.',
        'На 3016 метра слънцето е силно – слънцезащитният крем, слънчевите очила и шапката са задължителни.',
        'Добре е да носите челник, личните си лекарства и всичко необходимо за няколко дни далеч от цивилизацията.',
        'Санитарните условия са базови и обикновено споделени.',
        'Ако не сте свикнали с голяма надморска височина, имайте предвид, че 3016 метра са сериозна височина и е добре да дадете време на организма си да се адаптира.',
      ],
    },
    {
      text: [
        'Сонг-Кул не е за всеки. И това е хубавото. Пътищата са трудни. Нощите могат да бъдат студени. Условията са семпли. Няма да имате Wi-Fi, няма да можете да заредите телефона си навсякъде и няма да има какво да правите по стандартния списък с „топ 10 забележителности“.',
        'Ако търсите бутиков хотел, удобен транспорт и програма, изпълнена с активности, Сонг-Кул вероятно няма да е вашето място.',
        'Но ако сте готови да приемете малко неудобство в замяна на нещо много по-ценно – тишина, пространство и усещането, че за няколко дни сте излезли от обичайния ритъм на света – тогава Сонг-Кул може да се окаже един от най-силните моменти в цялото ви пътуване.',
        'Номадските семейства, които прекарват лятото тук, не създават туристическо представление. Те просто живеят живота си. Водят животните си към високите пасища. Разпъват юртите си. Приготвят храна. Посрещат гости. И когато сезонът свърши, събират всичко и се връщат обратно. Този ритъм е много по-стар от туризма.',
        'И може би точно това остава с вас, когато си тръгнете от Сонг-Кул – усещането, че за няколко дни сте живели по-бавно, по-просто и по-близо до природата. И че понякога, за да се почувствате свободни, не ви трябва повече. Трябва ви по-малко.',
      ],
    },
    {
      title: 'Сонг-Кул с Amelia Travel',
      cta: {
        before:
          'Сонг-Кул е един от акцентите в нашето пътуване до Киргизстан – маршрут, създаден за жени, които искат не просто да посетят Киргизстан, а да усетят неговите планини, номадска култура и начин на живот. Ако искате да видите Сонг-Кул по този начин, можете да разгледате ',
        linkText: 'пълната програма на нашето пътуване до Киргизстан',
  ...
  sections: [
    {
      text: [
        'Има места, за които можеш да прочетеш десетки статии, да изгледаш безброй видеа и да разгледаш стотици снимки, но въпреки това да не си представиш какво е да бъдеш там. Индия е едно от тях.',
        'Тя не се опитва да бъде тиха или лесна за разбиране. Посреща те с шумни улици, пълен трафик, аромати на подправки, ярки цветове и хора навсякъде около теб. След това, само няколко часа по-късно, може да се озовеш на място, където времето сякаш се движи по съвсем различен начин.',
        'И точно тези контрасти правят Индия толкова завладяваща.',
      ],
      image: {
        src: `${AMELIA_INDIA_BLOG_IMAGE_BASE}/india-otblizo-02.webp`,
        alt: 'Улица в Индия',
      },
    },
    {
      title: 'Първото впечатление е трудно да се забрави',
      text: [
        'Първите часове в Индия могат да бъдат малко overwhelming.',
        'Улиците са оживени, движението изглежда хаотично, а сетивата ти постоянно получават нова информация. Има музика, клаксони, разговори, миризма на подправки, дим от уличните кухни и цветове, които сякаш са навсякъде.',
        'Но след първоначалното усещане, че всичко се случва едновременно, започваш да забелязваш детайлите. Жена в ярко сари, която върви по улицата. Малък щанд с пресни плодове. Цветя, подредени пред храм. Възрастен човек, който наблюдава случващото се около него. Деца, които играят в малка уличка.',
        'Постепенно хаосът започва да придобива своя собствен ритъм.',
      ],
      image: {
        src: `${AMELIA_INDIA_BLOG_IMAGE_BASE}/india-otblizo-03.webp`,
        alt: 'Улици в Ню Делхи',
      },
    },
    {
      title: 'Цветовете са навсякъде',
      text: [
        'Индия не е цветна само на снимките.',
        'Цветовете са част от ежедневието – от дрехите и пазарите до храмовете, цветята и малките детайли, които можеш да откриеш на всяка крачка.',
        'Особено впечатляващи са традиционните индийски дрехи, които се превръщат в естествена част от пейзажа. Ярко розово, оранжево, жълто, червено и синьо се появяват сред прашните улици и старите сгради, създавайки контраст, който трудно можеш да забравиш.',
        'И може би именно затова Индия изглежда толкова различно през очите на човек, който идва за първи път. Тя не се нуждае от филтър.',
      ],
    },
    {
      title: 'Между шума има тишина',
      text: [
        'Това може би е един от най-интересните контрасти на Индия.',
        'Можеш да прекараш сутринта сред оживен пазар, а малко по-късно да се окажеш в храм или двор, където всичко изведнъж става спокойно.',
        'Шумът остава някъде далеч, хората говорят по-тихо, а за няколко минути просто наблюдаваш.',
        'Именно в тези моменти започваш да усещаш друга страна на Индия – по-бавна, по-съзерцателна и много по-тиха от първото ти впечатление.',
        'Може би това е и една от причините да не можеш да разбереш Индия само от снимки. Трябва да си там, за да усетиш тези противоположности едновременно.',
      ],
      image: {
        src: `${AMELIA_INDIA_BLOG_IMAGE_BASE}/india-otblizo-04.webp`,
        alt: 'Тих момент в Индия',
      },
    },
    {
      title: 'Храната е част от преживяването',
      text: [
        'В Индия храната не е просто нещо, което поръчваш, когато огладнееш. Тя е част от културата и от ежедневието.',
        'Подправките, ароматите, различните видове хляб, оризът, зеленчуковите ястия и регионалните специалитети превръщат всяко хранене в малко приключение.',
        'И ако досега си мислила за индийската кухня само като за къри, вероятно ще останеш изненадана от разнообразието, което те очаква.',
        'Понякога най-хубавото ястие няма да бъде в ресторанта, който си отбелязала предварително, а на място, което си открила случайно по пътя.',
      ],
    },
    {
      title: 'Индия не е само това, което виждаш',
      text: [
        'Една от причините да пътуваме е да видим неща, които не можем да намерим у дома. Но в Индия постепенно разбираш, че не става дума само за забележителностите.',
        'Разбира се, Тадж Махал е впечатляващ. Дворците на Раджастан са впечатляващи. Старите градове, храмовете и пазарите също.',
        'Но между тях има други моменти, които остават в паметта ти много по-дълго – разговор с местен човек, чаша чай, гледка от прозореца на влака, сутрешна разходка или няколко минути, в които просто наблюдаваш живота около себе си.',
        'Понякога именно тези малки моменти се оказват най-ценната част от пътуването.',
      ],
    },
    {
      title: 'Индия те кара да приемеш различното',
      text: [
        'Когато пътуваш до място, което е много различно от твоето ежедневие, неизбежно започваш да сравняваш. Как живеят хората? Какво ядат? Как общуват? Как прекарват деня си?',
        'Но постепенно разбираш, че не всичко трябва да бъде сравнявано. Различното не е непременно по-добро или по-лошо. Просто е различно.',
        'И може би това е един от най-ценните уроци на пътуването – да можеш да погледнеш към друг начин на живот с любопитство, вместо веднага да го преценяваш през собствените си представи.',
      ],
      image: {
        src: `${AMELIA_INDIA_BLOG_IMAGE_BASE}/india-otblizo-05.webp`,
        alt: 'Момент от Индия',
      },
    },
    {
      title: 'А после се прибираш',
      text: [
        'След Индия може да имаш чувството, че ти трябва малко време, за да подредиш всичко, което си видяла.',
        'Вероятно ще имаш стотици снимки, десетки истории и няколко любими момента, които няма да можеш да обясниш напълно. Може би ще ти липсват цветовете. Или храната. Или някой разговор, който си водила с човек, когото вероятно никога повече няма да срещнеш.',
        'А може би най-много ще ти липсва усещането, че всеки ден се случва нещо ново.',
        'И точно това е Индия – място, което едновременно може да те измори и да те зареди, да те обърка и да те накара да гледаш на света по различен начин.',
        'Между хаоса, цветовете и тишината Индия не просто се вижда. Тя се усеща. И може би затова едно пътуване дотам остава с теб много след като си се прибрала.',
      ],
    },
    {
      cta: {
        before: 'Ако тези думи те карат да поискаш да видиш Индия с очите си, разгледай ',
        linkText: 'нашето 14-дневно пътуване до Северна Индия',
        linkUrl: '/tour-item/india-tour/',
        after: ' – Ню Делхи, Джайпур, Агра и Варанаси, в малка група жени.',
      },
    },
  ],
};
...
export const AMELIA_BLOG_POSTS: readonly BlogPostContent[] = [
  MAROKO_ZA_ZHENI_PATESHESTVENICHKI,
  EZEROTO_SONG_KUL_KIRGISTAN,
  INDIA_OTBLIZO,
];

export const BLOG_POST_SLUGS = BLOG_POSTS.map((post) => post.slug);

export const AMELIA_BLOG_POST_SLUGS = AMELIA_BLOG_POSTS.map((post) => post.slug);

export function blogPostsForSite(siteId: SiteId): readonly BlogPostContent[] {
  return siteId === 'amelia' ? AMELIA_BLOG_POSTS : BLOG_POSTS;
}
...
export function findBlogPostBySlug(
  ...
  return blogPostsForSite(siteId).find((post) => post.slug === slug);
}
