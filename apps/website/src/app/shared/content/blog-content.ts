  ...
  sections: [
    ...
    },
    {
      ...
      text: [
        ...
        'Няколко съвета за по-безопасно пътуване:',
      ],
      boldList: [
        {
    ...
    },
    {
      ...
      text: [
        'Мароко е по-разнообразно и либерално, отколкото често си представяме. Не се очаква от туристките да носят забрадка, а в Маракеш и по крайбрежието ще видиш жени с най-различен стил на обличане.',
