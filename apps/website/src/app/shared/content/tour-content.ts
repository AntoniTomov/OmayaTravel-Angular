  ...
  return {
    ...
    itinerary: [
      ...
      },
      {
        ...
        description:
          'Днес оставяме града зад гърба си и поемаме на юг към високите планини, където пейзажът постепенно се променя. Спираме за обяд в малкото градче Кочкор – първата ни среща с живота в провинциален Киргизстан, а след това пътят се изкачва стръмно към Сон-Кьол – огромно алпийско езеро на над 3000 метра надморска височина, обградено от открити пасища и летни лагери на номадски общности. Вечерята и първата ни нощувка в традиционен юртов лагер ни очакват.',
        descriptionHighlights: [
          { term: 'Сон-Кьол', href: 'https://ameliatravel.bg/ezeroto-song-kul-kirgistan/' },
        ],
      ...
      },
      {
        ...
        description:
          'Слизаме от планината и днес достигаме северния бряг на Исък-Кул – едно от най-големите високопланински езера в света. Чолпон-Ата е основният курортен град на брега, а следобедът прекарваме между плажа и впечатляващия музей на открито с петроглифи, където хиляди древни скални гравюри разказват за хората, живели тук много преди появата на юртите. Обядът и вечерята са включени.',
        descriptionHighlights: [{ term: 'музей на открито с петроглифи' }],
