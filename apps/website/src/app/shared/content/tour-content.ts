...
/**
 * A phrase inside an itinerary description that is set apart from the prose, and
 * optionally points at an external reference for it.
 */
export interface TourDescriptionHighlight {
  /** Verbatim phrase from the description; marked up on its first occurrence. */
  term: string;
  /** External reference the phrase links to, when there is one worth citing. */
  href?: string;
}
...
export interface TourItineraryDay {
  ...
  title: string;
  description: string;
  descriptionHighlights?: readonly TourDescriptionHighlight[];
...
export interface TourFaqItem {
  ...
  /** Rendered as a list after the paragraphs, for answers that are a packing list or similar. */
...
const AMELIA_INDIA_ASSET_BASE = '/assets/images/amelia/tours/india';
...
export function findTourBySlug(
  ...
  if (siteId === 'amelia' && slug === 'india-tour') {
    return createAmeliaIndiaTour();
  }
...
function createAmeliaKyrgyzstanTour(): TourDetailContent | undefined {
  ...
  return {
    ...
    notIncluded: [
      ...
      'Доплащане за единична стая - 100 EUR (важи само за настаняването в хотела в Бишкек, за юртите и къщите за гости е задължително споделянето на стая)',
    ],
    itinerary: [
      {
        day: 1,
        ...
        descriptionHighlights: [{ term: 'Бишкек' }, { term: 'традиционен фолклорен концерт' }],
      ...
      },
      {
        ...
        description:
          'Цял ден, който съчетава планинската природа около Бишкек с живота и историята на столицата. Сутринта се отправяме към националния парк Ала Арча – впечатляваща планинска клисура с ледникови реки и борови гори, само на час от Бишкек. След това се връщаме в столицата за следобедна обиколка из широките булеварди от съветската епоха, оживените пазари и знаковите паметници на града.',
        descriptionHighlights: [{ term: 'Ала Арча' }],
        accommodation: '3* хотел в Бишкек (двойна стая)',
        meals: ['закуска', 'обяд'],
      },
      {
        ...
        description:
          'Днес оставяме града зад гърба си и поемаме на юг към високите планини, където пейзажът постепенно се променя. Спираме за обяд в малкото градче Кочкор – първата ни среща с живота в провинциален Киргизстан, а след това пътят се изкачва стръмно към Сон-Кул – огромно алпийско езеро на над 3000 метра надморска височина, обградено от открити пасища и летни лагери на номадски общности. Вечерята и първата ни нощувка в традиционен юртов лагер ни очакват.',
        descriptionHighlights: [
          { term: 'Сон-Кул', href: 'https://ameliatravel.bg/ezeroto-song-kul-kirgistan/' },
        ],
      ...
      },
      {
        ...
        descriptionHighlights: [{ term: 'двучасова езда през високопланинските пасища' }],
        accommodation: 'Лагер с юрти (до 4 души в юрта)',
        meals: ['закуска', 'обяд', 'вечеря'],
      },
      {
        ...
        description:
          'След спускането от Сон-Кул ни очаква едно от най-интересните и практични преживявания по време на пътуването – демонстрация на изграждане на юрта. Стъпка по стъпка ще научим как се изграждат тези забележителни преносими домове. Обядваме в дома на местно семейство в Кочкор, а след това продължаваме на изток покрай южния бряг на Исък-Кул към село Боконбаево, където ни очаква вечеря в юртов лагер.',
        descriptionHighlights: [{ term: 'демонстрация на изграждане на юрта' }],
        accommodation: 'Лагер с юрти (до 4 души в юрта)',
        meals: ['закуска', 'обяд', 'вечеря'],
      },
      {
        ...
        description:
          'Един от най-впечатляващите дни от пътуването. Сутринта започваме с демонстрация на лов с орли – рядка среща с една от най-древните живи традиции на Централна Азия. След това се отправяме към каньона Сказка, където изваяни от вятъра червени и охрени скали се извисяват край брега на езерото. Пътят продължава през зелената долина Барскоон до Каракол – най-големия град в източната част на страната. Там ни очакват обиколка на града с Дунганската джамия и дървената църква „Света Троица“, обяд в дома на местно семейство и вечеря в ресторант.',
        descriptionHighlights: [
          { term: 'демонстрация на лов с орли' },
          { term: 'Дунганската джамия' },
          {
            term: 'дървената църква „Света Троица“',
            href: 'https://en.wikipedia.org/wiki/Holy_Trinity_Church,_Karakol',
          },
        ],
      ...
      },
      {
        ...
        description:
          'Бягство за една нощ в едно от най-спокойните кътчета на Киргизстан. Пътеката към Алтън Арашан се вие през гори и речна долина, водейки ви до уединена къща за гости, където от земята извират естествени горещи извори. След дните, прекарани в езда и преходи, потапянето в топлите термални води, сред тишината на планината, е напълно заслужена награда.',
        descriptionHighlights: [{ term: 'Алтън Арашан' }],
      ...
      },
      {
        ...
        description:
          'Слизаме от планината и днес достигаме северния бряг на Исък-Кул – едно от най-големите високопланински езера в света. Чолпон-Ата е основният курортен град на брега, а следобедът прекарваме между плажа и впечатляващия музей на открито с древни петроглифи, където хиляди скални гравюри разказват за хората, живели тук много преди появата на юртите. Обядът и вечерята са включени.',
        descriptionHighlights: [{ term: 'музей на открито с древни петроглифи' }],
      ...
      },
      {
        ...
        description:
          'Последният ден ни предлага две заключителни срещи с многопластовата история и живата култура на Киргизстан. Спираме при кулата Бурана – самотно минаре от XI век, извисяващо се над долината Чу, а след това ще имаме възможност да видим Кок-бору – древна и вълнуваща конна игра, която е важна част от киргизката култура и идентичност. Обядваме в дома на местно семейство, а след това пътят ни отвежда обратно към Бишкек за последната ни нощувка.',
        descriptionHighlights: [
          { term: 'кулата Бурана' },
          {
            term: 'да видим Кок-бору – древна и вълнуваща конна игра',
            href: 'https://ich.unesco.org/en/RL/kok-boru-traditional-horse-game-01294',
          },
        ],
        accommodation: '3* хотел в Бишкек (двойна стая)',
        meals: ['закуска', 'обяд'],
      ...
      items: [
        {
          ...
          answer: [
            ...
            'От София тръгвате заедно с представителка на Amelia Travel, а в Киргизстан към групата се присъединява местна екскурзоводка, която познава страната отвъд туристическите маршрути.',
        ...
        },
        {
          ...
          answer: [
            'Не. В Киргизстан напрежението е 220 V, а контактите са същите като в България, така че си носиш обичайните зарядни. В юртите и по-отдалечените места токът може да бъде ограничен или липсва през част от деня, затова вземи външна батерия.',
          ],
        },
        {
          question: 'Може ли да се пие вода от чешмата?',
          answer: [
            'Не го препоръчваме. Пий бутилирана или преварена вода. На преходи и екскурзии носи бутилка за многократна употреба и я пълни от бутилирана или преварена вода.',
          ],
        },
        {
          question: 'Каква храна да очаквам и съобразявате ли се с хранителни режими?',
          answer: [
            'Киргизката кухня е изградена върху месо, тесто и мляко. Традиционни ястия са лагман (фиде със зеленчуци и месо), плов, манты, самса и бешбармак. Хлябът е пресен и вкусен, а към чая ще получаваш конфитюри, мед, ядки и кисело мляко. Ако искаш да опиташ, има и кумис, ферментирало кобилешко мляко, който е специфичен на вкус.',
            'Храненето е включено според програмата, а всичко, което не е изрично посочено, е за твоя сметка. Съобразяваме се с хранителни режими и алергии: вегетарианските варианти (супи, салати, тестени изделия, яйца) се намират, но изборът е по-малък, особено в юртите и селата. За вегани и хора с алергии е по-трудно, затова ни кажи при записването и ще го уточним с местния партньор.',
          ],
        },
        {
          question: 'Пари, карти и бакшиши?',
          answer: [
            'Местната валута е сомът. Най-удобно е да носиш евро или долари в брой (чисти банкноти, без повреди) и да ги обмениш в Бишкек, Каракол или друг по-голям град. Картите се приемат в хотели, ресторанти и магазини в големите градове, но в селата, юртите и на пазарите ти трябват пари в брой. Банкомати има в градовете, но не разчитай на тях в планината, затова изтегли или обмени достатъчно, преди да тръгнеш към юртите.',
            'Бакшишите не са задължителни, но се ценят. В ресторантите остави около 10%, ако сервизът не е включен, а за местния гид и шофьора остави по преценка в края на пътуването, ако си доволна от услугата.',
          ],
        },
        {
          question: 'Какво да облека?',
          answer: [
            'През лятото дните са топли, но вечер и на височина (например при юртите) е доста студено, понякога близо до нулата. Обличай се на пластове:',
          ],
          bullets: [
            'удобни, здрави обувки за ходене и за неравен терен;',
            'топъл полар и леко непромокаемо яке, защото времето в планината се сменя бързо;',
            'шапка, слънчеви очила и крем с висок фактор, защото слънцето на височина е силно;',
            'дълги панталони и дрехи, които покриват раменете и коленете, за селата и посещения на джамии.',
          ],
        },
      ],
    },
    ...
    itinerary: [
      {
        ...
        descriptionHighlights: [{ term: 'джамията „Хасан II“' }],
      ...
      },
      {
        ...
        descriptionHighlights: [{ term: 'Рас ел-Ма' }],
        accommodation: 'Хотел в сърцето на синия град',
        meals: ['закуска'],
      },
      {
      ...
      },
      {
        ...
        descriptionHighlights: [
          { term: 'Фес ел Бали', href: 'https://whc.unesco.org/en/list/170/' },
          {
            term: 'работилници Шуара',
            href: 'https://en.wikipedia.org/wiki/Chouara_Tannery',
          },
          { term: 'Ал-Карауин' },
        ],
        accommodation: 'Риад в медината на Фес',
      ...
      },
      {
        ...
        descriptionHighlights: [
          { term: 'кедровата гора край Азру' },
          { term: 'Мерзуга' },
          { term: 'дюните на Ерг Шеби' },
          { term: 'Сахара' },
        ],
      ...
      },
      {
        ...
        descriptionHighlights: [{ term: 'Хамлия' }, { term: 'музиката гнауа' }],
      ...
      },
      {
        ...
        descriptionHighlights: [{ term: 'клисурата Тодра' }, { term: 'долината Дадес' }],
      ...
      },
      {
        ...
        descriptionHighlights: [
          { term: 'Скура' },
          { term: 'Tawabil - женски кооператив в Уарзазат' },
          { term: 'Atlas Studios' },
          { term: 'Аит Бен Хаду', href: 'https://whc.unesco.org/en/list/444/' },
        ],
      ...
      },
      {
        ...
        descriptionHighlights: [
          { term: 'градината Мажорел' },
          { term: 'Le Jardin Secret' },
          { term: 'Amal Women’s Training Center' },
        ],
        accommodation: 'Риад в медината на Маракеш',
        meals: ['закуска'],
      },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: [
            'Организираме пътуването през април и май, защото през пролетта температурите са поносими и в планината, и в пустинята, и в градовете. Лятото в Сахара може да е много горещо, а през зимата проходите понякога са затрупани със сняг. Следим прогнозата преди всяко тръгване и те уведомяваме, ако нещо може да промени програмата.',
          ],
        },
        {
        ...
        {
          question: 'Откъде да изтегля или обменя пари в брой за пътуването?',
          answer: [
            'Марокански дирхами можеш да си купиш и предварително в България, в някои обменни бюра, но не навсякъде и обикновено при заявка. Ако не успееш, няма проблем: вземи евро в брой и ги обмени на място, на летището, в банка или в обменно бюро. Курсът е сходен навсякъде и не е нужно да търсиш най-доброто предложение.',
        ...
        {
          question: 'Трябва ли ми адаптер за контактите?',
          answer: ['Не. Мароко ползва същите контакти и същото напрежение като България.'],
        },
        {
          question: 'Може ли да се пие вода от чешмата?',
          answer: [
        ...
        },
        {
          ...
          answer: [
            'Мароко не изисква конкретни ваксини за влизане, но си струва рутинните ти имунизации да са актуални. Някои пътуващи избират профилактика срещу хепатит А и коремен тиф, а личният ти лекар или специалистите от Имунизационен кабинет за пътуващи в чужбина ще те посъветват според твоята история.',
...
function createAmeliaIndiaTour(): TourDetailContent {
  const indiaHeroImage: TourImage = {
    src: `${AMELIA_INDIA_ASSET_BASE}/india-hero.webp`,
    alt: 'Тадж Махал в Агра, Индия',
    width: 2560,
    height: 515,
  };
  const indiaHighlightImage = (index: 1 | 2 | 3 | 4 | 5): TourImage => ({
    src: `${AMELIA_INDIA_ASSET_BASE}/highlights/india-highlight-${index}.webp`,
    alt: 'Северна Индия отблизо',
    width: 150,
    height: 150,
  });
  ...
  return {
    ...
    introduction: [
      ...
      'Делхи ще ни посрещне с оживените си улици, миризмата на подправки и непрекъснатите клаксони, а само след час ще ни остави в тишината на градините около гробницата на Хумаюн. В Джайпур ще се разходим сред розовите фасади на стария град, ще надникнем в света на махараджите и ще видим как местни жени превръщат обикновения плат в цветни истории с помощта на дървени блокчета и естествени бои - техника, предавана от поколения. По пътя към Агра ще слезем до Чанд Баори - стъпаловиден кладенец, чиито размери трудно се побират в един поглед. А във Варанаси ще застанем два пъти пред една и съща река, но ще я усетим по два напълно различни начина: вечерта, когато е огън, песнопения и хиляди хора по стъпалата, и рано сутринта, когато е само лодката и градът, който още не се е събудил.',
      'Четиринайсет дни, малка група жени и една страна, която не бърза да се обяснява.',
    ],
    highlights: [
      {
        title: {
          text: 'Тадж Махал на живо - мраморът, който сменя цвета си според светлината.',
          linkText: '',
          link: '',
        },
        image: indiaHighlightImage(1),
      },
      {
        title: {
          text: 'Ганг два пъти - вечерната аарти от лодка (огън, камбани, хиляди хора) и същата река на изгрев, когато е само тишина.',
          linkText: '',
          link: '',
        },
        image: indiaHighlightImage(2),
      },
      {
        title: {
          text: 'Блокпечат с жените от Багру - ръчни дървени блокове, естествени багрила, техника от поколения.',
          linkText: '',
          link: '',
        },
        image: indiaHighlightImage(3),
      },
      {
        title: {
          text: 'Стария Делхи - Чандни Чоук пеша и разходка със Salaam Baalak Trust, водена от младежи, живели по тези улици.',
          linkText: '',
          link: '',
        },
        image: indiaHighlightImage(4),
      },
      {
        title: {
          text: 'Чанд Баори - 3500 стъпала на 13 нива, 30 метра надолу в земята.',
          linkText: '',
          link: '',
        },
        image: indiaHighlightImage(5),
      },
    ],
    included: [
      '13 нощувки в хотели по програмата или подобни, на база двойна стая',
      '13 закуски и 1 вечеря (Harsoli Haveli)',
      'Вътрешен полет Варанаси – Ню Делхи, икономична класа',
      'Влак Агра – Варанаси, AC chair car',
      'Целият наземен транспорт и трансферите по програмата с климатизирано превозно средство',
      'Входни такси за всички обекти по програмата',
      'Джипове до Амбер Форт',
      'Работилница по традиционен блокпечат в Багру с местни жени',
      'Йога сесия в Джайпур',
      'Кулинарна демонстрация с вечеря в Harsoli Haveli',
      'Разходка със Salaam Baalak Trust в Стария Делхи',
      'Рисунка с къна',
      'Разходка с електрическа рикша във Варанаси',
      'Две разходки с лодка по Ганг – вечерната аарти и изгревът, вкл. спасителни жилетки',
      'Местни англоговорящи водачки през цялото пътуване',
      'Придружител от Amelia Travel от София',
      '2 бутилки вода (0,5 л) на човек на ден по време на пътуванията с автомобил',
      'Медицинска застраховка',
      'Всички местни данъци и такси',
    ],
    notIncluded: [
      'Международен самолетен билет София – Делхи – София',
      'Виза за Индия',
      'Обеди и вечери извън посочените в програмата',
      'Напитки, вкл. вода, в хотелите и ресторантите',
    ...
    itinerary: [
      {
        day: 1,
        title: 'Добре дошли в Ню Делхи',
        description:
          'Първата ни среща с Индия ще бъде в Делхи – град, в който няколко различни епохи съществуват едновременно. Днешната столица е събрала в себе си следите на няколко по-стари града, строени, разрушавани и възстановявани през вековете, и всичко това живее едновременно с модерния мегаполис. На летището ще ни посрещне местният ни представител и ще ни изпрати до хотела. Ако времето ни позволи, първата ни разходка ще бъде в Connaught Place – един от централните райони на Ню Делхи, разположен около колониални сгради с характерни колонади. Днес тук има магазини, ресторанти, кина и кафенета. А на Janpath Market ще можем да започнем с първите малки покупки – пъстри сарита, бродирани чанти и онези дребни неща, които по-късно ще ни напомнят за Индия.',
        descriptionHighlights: [{ term: 'Connaught Place' }, { term: 'Janpath Market' }],
        accommodation: 'Хотел в старата част на Ню Делхи',
        meals: [],
      },
      {
        day: 2,
        title: 'Историята на Делхи',
        description:
          'Днес ще се движим между няколко епохи на един и същи град. Започваме при Кутуб Минар (Qutub Minar) – 72,5-метрова тухлена кула, построена през 1192 г., която се издига над руините на исторически комплекс, оформян в продължение на векове. Обект на световното наследство на ЮНЕСКО, тя е един от ранните и най-впечатляващи примери за ислямска архитектура в Индия. Оттам минаваме през представителната част на Ню Делхи – Портата на Индия (India Gate), военният мемориал и един от символите на града, и Rashtrapati Bhavan – официалната резиденция на президента на Индия, чиито мащаби се усещат истински чак когато застанем пред нея. Следобед сме в Gurudwara Bangla Sahib – един от най-значимите сикхски храмове в Делхи, свързан с осмия гуру Гуру Хар Кришан. Около свещеното езеро във вътрешния двор хората идват и си отиват през целия ден, а обувките остават на входа. Тук впечатлява не толкова архитектурата, колкото самото движение на храма. Ще завършим деня сред градините на гробницата на Хумаюн – един от архитектурните предшественици на Тадж Махал. След шумните улици на Делхи тук всичко изведнъж става по-тихо: геометрични градини, водни канали, червен пясъчник. В същия комплекс са и други гробници от XVI век, както и Arab Serai – мястото, където са живели занаятчиите, работили по изграждането на гробницата.',
        descriptionHighlights: [
          { term: 'Кутуб Минар (Qutub Minar)' },
          { term: 'Портата на Индия (India Gate)' },
          { term: 'Gurudwara Bangla Sahib' },
          { term: 'гробницата на Хумаюн' },
        ],
        accommodation: 'Хотел в старата част на Ню Делхи',
        meals: ['закуска'],
      },
      {
        ...
        title: 'Старият Делхи',
        description:
          'Днес ще видим Делхи отблизо – по тесните му улици, сред пазарите и местата, където градът не просто се разглежда, а се преживява. Първо минаваме покрай Джама Масджид (Jama Masjid) – една от най-големите джамии в Индия, построена в средата на XVII век по времето на моголския император Шах Джахан, същия, който изгражда и Тадж Махал. Червеният пясъчник, белият мрамор и високите минарета се виждат отдалеч, а около джамията животът на Стария Делхи продължава както винаги – шумен, пъстър и непрекъснат. И оттам влизаме в Чандни Чоук (Chandni Chowk). Тук няма много място за бавна разходка. Има подправки, сушени плодове, сребърни бижута, пъстри платове, сладкиши, малки магазинчета и тесни улички, по които животът се движи във всички посоки едновременно. Рикши се разминават на сантиметри, някой пържи нещо на улицата, отворените магазини изнасят стоката си почти до самия тротоар. Точно тук ще усетим онази Индия, която вероятно сме си представяли, преди да дойдем. Следобед ни очаква една по-различна разходка. Salaam Baalak Trust е организация, която от 1988 г. работи с деца, живеещи и работещи по улиците на Делхи, като им осигурява грижа, образование и подкрепа. Разходката продължава почти два часа и е водена от младежи, които самите са живели на улицата, преди да попаднат под грижата на организацията. Ще преминем през Пахаргандж (Paharganj) и района около гара Ню Делхи (New Delhi Railway Station) – места, покрай които се минава бързо и рядко се спира. Тук ще ги погледнем от друга перспектива – през историите на хората, които познават тези улици отвътре. Това е от онези разходки, след които градът изглежда малко по-различно. Не защото сме видели нещо ново, а защото сме го видели през нечии очи.',
        descriptionHighlights: [
          { term: 'Джама Масджид (Jama Masjid)' },
          { term: 'Чандни Чоук (Chandni Chowk)' },
          { term: 'Salaam Baalak Trust', href: 'https://www.salaambaalaktrust.com/' },
        ],
        accommodation: 'Хотел в старата част на Ню Делхи',
        meals: ['закуска'],
      },
      {
        day: 4,
        title: 'Ню Делхи → Джайпур',
        description:
          'Днес оставяме Делхи и потегляме на юг, към Джайпур. Пътят е около 297 км и отнема близо четири часа и половина по магистралата, но е от онези пътувания, в които не се спи. Делхи постепенно остава зад нас, после започват полета, малки градчета, крайпътни чайни и камиони, изрисувани така, сякаш някой ги е обличал за празник. Някъде по средата пейзажът вече е Раджастан – по-сух, по-открит, с онази светлина, която прави всичко малко по-жълто. Джайпур е известен като Розовия град и името не е случайно. През 1876 г. махараджа Рам Сингх нарежда сградите в старата част да бъдат боядисани в розово в знак на гостоприемство преди посещението на принца на Уелс. Оттогава са минали близо век и половина, а старият град и до днес се пребоядисва в същия цвят. Теракотовите фасади, белите орнаменти по тях и сините врати са първото, което ще видим, когато влезем през някоя от старите порти. Ще се отбием в Бирла Мандир (Birla Mandir) – белият мраморен храм в подножието на хълма Моти Дунгри, посветен на Вишну и на Лакшми, богинята на благополучието.',
        descriptionHighlights: [{ term: 'Бирла Мандир (Birla Mandir)' }],
        accommodation: 'Хотел в Джайпур',
        meals: ['закуска'],
      },
      {
        day: 5,
        title: 'Джайпур',
        description:
          'Днес Джайпур ще ни покаже една от най-пъстрите си страни, но започваме бавно – с йога сесия сутринта, преди градът да се е събудил. После тръгваме с джипове към хълмовете над Джайпур, където е Амбер Форт (Amber Fort). По пътя спираме при Панна Меена Кунд (Panna Meena Kund) – впечатляващ стъпаловиден кладенец, в който симетрични стълби слизат надолу от четирите страни. Такива кладенци са били не просто начин за събиране и съхраняване на вода, а и естествено място за срещи и ежедневен живот. Оттам продължаваме към Амбер Форт (Amber Fort) – обект на световното наследство на ЮНЕСКО и една от големите забележителности на Раджастан. Крепостта съчетава моголски и индуистки традиции: високи стени, поредица от порти, вътрешни дворове и каменни алеи, а отгоре се откриват гледки към хълмовете и езерото под тях. В комплекса ще видим и храма Джагат Широмани (Jagat Shiromani Temple), както и музея Anokhi, посветен на традиционния ръчен блокпечат. На връщане минаваме покрай Хава Махал (Hawa Mahal) – Двореца на ветровете и един от символите на Джайпур. Розовата му фасада е всъщност външната стена на двореца, надупчена със стотици малки прозорчета, през които жените от кралското семейство са можели да наблюдават улицата, без да бъдат виждани. След това спираме при Джал Махал (Jal Mahal) – дворец, който сякаш плува насред езерото Ман Сагар. Следобед ни очаква една от специалните срещи в Джайпур. Ще се срещнем с местни жени от Багру (Bagru), район, известен с традиционния си ръчен блокпечат върху текстил. Ще видим как с помощта на ръчно изработени дървени блокове и естествени багрила върху плата постепенно се появяват сложни десени. Багру е особено известно с използването на растителни багрила и техниката dabu – традиционен метод за отпечатване с кал, който създава характерните за района мотиви.',
        descriptionHighlights: [
          { term: 'с йога сесия сутринта' },
          { term: 'Амбер Форт (Amber Fort)', href: 'https://en.wikipedia.org/wiki/Amber_Fort' },
          { term: 'Панна Меена Кунд (Panna Meena Kund)' },
          { term: 'Джагат Широмани (Jagat Shiromani Temple)' },
          { term: 'Хава Махал (Hawa Mahal)' },
          {
            term:
              'Ще се срещнем с местни жени от Багру (Bagru), район, известен с традиционния си ' +
              'ръчен блокпечат върху текстил.',
          },
        ],
        accommodation: 'Хотел в Джайпур',
        meals: ['закуска'],
      },
      {
        ...
        title: 'Джайпур',
        description:
          'Днес ще забавим темпото и ще погледнем към града през неговото изкуство, история и традиции. Започваме със Сити Палас (City Palace) – комплексът в сърцето на стария град, чието изграждане започва през XVIII век и който и до днес е свързан с някогашното кралско семейство на Джайпур. Дворове, порти, храмове и дворци се редуват един след друг – Чандра Махал, Мубарак Махал, залата за аудиенции Диван-и-Хас и храмът Говинд Дев Джи. Оттам минаваме към Джантар Мантар (Jantar Mantar) – обсерватория от XVIII век и обект на световното наследство на ЮНЕСКО, само на няколко крачки от двореца. Деветнайсет каменни инструмента са построени за наблюдение и измерване на движението на небесните тела, между които е и най-големият каменен слънчев часовник в света. Следобед ще украсим ръцете си с къна. Ден по-рано десените се появяваха върху плата в Багру, а сега ще се появят върху кожата ни – рисувани бавно и на ръка. Вечерта, в Harsoli Haveli ще наблюдаваме демонстрация на традиционно индийско готвене – подправките, начинът на приготвяне и онези аромати, които вече няколко дни усещаме навсякъде около себе си. А после ще седнем заедно на масата.',
        descriptionHighlights: [
          { term: 'Сити Палас (City Palace)' },
          {
            term:
              'Чандра Махал, Мубарак Махал, залата за аудиенции Диван-и-Хас и храмът ' +
              'Говинд Дев Джи.',
          },
          { term: 'в Harsoli Haveli ще наблюдаваме демонстрация на традиционно индийско готвене' },
        ],
        accommodation: 'Хотел в Джайпур',
      ...
      {
        day: 7,
        title: 'Джайпур → Абанери → Агра',
        description:
          'Днес напускаме Джайпур и се насочваме на изток, към Агра – градът на Тадж Махал. Пътят е около 256 км и отнема близо пет часа, а по средата спираме на място, което малко хора очакват. Абанери е неголямо село в Раджастан, но в него се намира Чанд Баори (Chand Baori) – един от най-старите и най-дълбоки стъпаловидни кладенци в Индия, изграден между IX и X век. Три от стените му са покрити със стъпала – около 3500 на брой, разположени на 13 нива и подредени в прецизна геометрия. Отгоре гледката е почти хипнотизираща – ред след ред стъпала се спускат към дъното на кладенеца, на около 30 метра под земята. Чанд Баори е бил жизненоважен за хората в тази суха част на Раджастан – място, откъдето са черпили вода през цялата година, но и пространство, което остава прохладно дори през най-горещите месеци. До него се намира храмът Харшат Мата (Harshat Mata Temple), посветен на богинята на радостта и щастието. След това продължаваме към Агра.',
        descriptionHighlights: [
          { term: 'Чанд Баори (Chand Baori)' },
          { term: 'Харшат Мата (Harshat Mata Temple)' },
        ],
        accommodation: 'Хотел в Агра',
        meals: ['закуска'],
      },
      {
        day: 8,
        title: 'Агра → Фатехпур Сикри → Агра',
        description:
          'Сутринта ще посетим Агра Форт (Agra Fort) – крепостта, която в продължение на три поколения е била резиденция на моголските императори. Зад масивните стени от червен пясъчник се крие цял комплекс от дворци, градини, джамии и зали за официални аудиенции, в които ислямските и индуистките архитектурни елементи се преплитат. От някои от терасите се открива гледка към Тадж Махал от другата страна на реката. След това ще потеглим към Фатехпур Сикри (Fatehpur Sikri) – столицата, която император Акбар изгражда през XVI век и напуска около 15 години по-късно. Целият град е изграден от червен пясъчник – дворци, вътрешни дворове, павилиони и монументални порти, сред които е и Буланд Дарваза (Buland Darwaza), една от най-високите порти в света. Днес Фатехпур Сикри е необичайно добре запазен град от епохата на Моголите – място, през което можеш да се разхождаш сред дворци и дворове, които отдавна са останали без своите обитатели. След посещението се връщаме в Агра.',
        descriptionHighlights: [
          { term: 'Агра Форт (Agra Fort)', href: 'https://whc.unesco.org/en/list/251/' },
          { term: 'Фатехпур Сикри (Fatehpur Sikri)' },
          { term: 'Буланд Дарваза (Buland Darwaza)' },
        ],
        accommodation: 'Хотел в Агра',
        meals: ['закуска'],
      },
      {
        day: 9,
        title: 'Агра и Тадж Махал',
        description:
          'Има места, които си виждала толкова пъти на снимки, че си мислиш, че вече ги познаваш. Тадж Махал е едно от тях. Докато не застанеш пред него. Мраморът променя нюанса си според светлината, а отблизо се вижда нещо, което снимките трудно показват – фините орнаменти, инкрустирани с полускъпоценни камъни, и прецизността, с която е изграден всеки детайл. Симетрията е почти съвършена и има само едно изключение – саркофагът на Шах Джахан, добавен по-късно до този на съпругата му Мумтаз Махал. Строителството продължава повече от две десетилетия, а днес Тадж Махал е обект на световното наследство на ЮНЕСКО. След това отиваме на другия бряг на Ямуна, при една много по-малка гробница. Гробницата на Итмад-уд-Даула (Itmad-ud-Daula’s Tomb) е построена преди Тадж Махал и често е наричана „малкият Тадж“. Поръчва я Нур Джахан – съпругата на император Джахангир и една от най-влиятелните жени в моголската история – за своя баща. Тук белият мрамор е съчетан с фини решетъчни орнаменти и деликатни инкрустации. А след мащаба на Тадж Махал това място носи нещо друго – тишина и усещане за близост.',
        descriptionHighlights: [
          { term: 'Тадж Махал', href: 'https://whc.unesco.org/en/list/252/' },
          { term: 'Итмад-уд-Даула (Itmad-ud-Daula’s Tomb)' },
        ],
        accommodation: 'Хотел в Агра',
        meals: ['закуска'],
      },
      {
        ...
        title: 'Агра → Варанаси',
        description:
          'Днес сменяме не само града, но и ритъма на пътуването. Ставаме рано – влакът тръгва в шест сутринта и пътува около седем часа на изток. През прозореца ще минава северноиндийската равнина: полета, малки гари, села, хора, които чакат по пероните. Пътуването с влак в Индия е преживяване само по себе си – начин да видиш страната не като поредица от места, а като живот, който се движи между тях. Варанаси, където пристигаме следобед, е един от най-старите непрекъснато населявани градове в света и едно от най-свещените места за индуистите. Разположен на брега на Ганг (Ganges), градът има свой собствен ритъм – шумен, духовен, понякога хаотичен и не винаги лесен за разбиране. Тук животът и смъртта са част от един и същ пейзаж, а реката присъства във всичко. Варанаси е известно и с бенареските сарита (Banarasi sarees) – традиционна коприна, тъкана на ръка от местни майстори, често с фини златни и сребърни нишки. След пристигането се настаняваме в хотела, а вечерта остава свободна.',
        descriptionHighlights: [{ term: 'Ганг (Ganges)' }],
        accommodation: 'Хотел във Варанаси',
        meals: [],
      },
      {
        day: 11,
        title: 'Варанаси и Ганг',
        description:
          'Днес ще оставим програмата да се движи малко по-бавно. По бреговете на Ганг се простират гхати – каменни стъпала, които слизат към реката и по които протича голяма част от ежедневието на Варанаси. Хората идват да се къпят, да перат, да се молят, да седнат, да започнат деня си. Два от гхатите са кремационни и там кладите горят непрекъснато – смъртта тук не е скрита, а е част от същия бряг, на който други се къпят. Това е част от живота на Варанаси, но е добре да сме подготвени за срещата с нея. В зоните на кремация снимането не е позволено. Ще посетим и района на Каши Вишванат (Kashi Vishwanath) – един от най-почитаните храмове, посветени на Шива, и едно от най-свещените места в индуизма. После се качваме на електрически рикши и навлизаме в старите улички зад гхатите. А когато денят започне да се оттегля, ще се качим на лодка. От водата ще наблюдаваме вечерната церемония аарти (Ganga Aarti) – огън, камбани, песнопения и стотици хора, събрани по стъпалата.',
        descriptionHighlights: [
          { term: 'Каши Вишванат (Kashi Vishwanath)' },
          { term: 'От водата ще наблюдаваме вечерната церемония аарти (Ganga Aarti)' },
        ],
        accommodation: 'Хотел във Варанаси',
        meals: ['закуска'],
      },
      {
        day: 12,
        title: 'Варанаси при изгрев',
        description:
          'Ако вечерта Варанаси е огън и движение, сутринта е нещо съвсем различно. Ще се качим на лодка още преди разсъмване и ще гледаме как слънцето изгрява над Ганг (Ganges). Градът тъкмо се събужда. По гхатите постепенно се появяват хора – някои за молитва, други за ритуал, трети просто за началото на новия ден. Водата е спокойна, звуците са малко, а от лодката всичко се вижда наведнъж. След закуска се отправяме към Сарнат (Sarnath) – само на около десет километра от Варанаси, но с напълно различна атмосфера. Тук, през V век пр.н.е., Буда изнася първата си проповед и поставя началото на учението, което по-късно ще стане будизъм. Ще видим Дхамек Ступа (Dhamek Stupa) – масивна цилиндрична структура от камък и тухла, разположена на мястото, свързано с първата проповед на Буда. Ще посетим и Чаукханди Ступа (Chaukhandi Stupa), както и Археологическия музей на Сарнат (Sarnath Archaeological Museum), който съхранява хиляди находки, открити в района, сред които е Лъвският капител на Ашока – скулптура от III век пр.н.е., която днес е част от националната емблема на Индия.',
        descriptionHighlights: [
          { term: 'Ганг (Ganges)' },
          { term: 'Сарнат (Sarnath)' },
          { term: 'Дхамек Ступа (Dhamek Stupa)' },
          { term: 'Археологическия музей на Сарнат (Sarnath Archaeological Museum)' },
        ],
        accommodation: 'Хотел във Варанаси',
        meals: ['закуска'],
      },
      {
        day: 13,
        title: 'Варанаси → Ню Делхи',
        description:
          'Днес се връщаме в Ню Делхи. Полет Варанаси – Ню Делхи с IndiGo 2321, 12:20–13:45 ч. / Economy. След пристигането ще се отправим към хотела. Това е последната ни вечер в Индия. Време е да забавим темпото, да си припомним последните дни и вероятно да открием, че вече имаме повече снимки, истории и вътрешни шеги, отколкото сме очаквали.',
        accommodation: 'Africa Avenue',
        meals: [],
      },
      {
        day: 14,
        title: 'До следващото пътуване',
        description:
          'Последна сутрин в Индия, преди да поемем обратно към България. Тръгваме си с усещането, че сме видели много повече от няколко известни места. Видяхме градове, които не си приличат. Срещнахме хора, които живеят с традиции, различни от нашите. Опитахме нови вкусове. Вървяхме по шумни улици и стояхме в тишината на древни градини. Видяхме Тадж Махал на живо и посрещнахме изгрева над Ганг. И може би това е едно от най-хубавите неща в Индия – че не можеш да я подредиш напълно в главата си. Можеш само да я преживееш. До следващото пътуване.',
        accommodation: null,
        meals: [],
      },
    ],
    gallery: [
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/08_taj_mahal_domes.webp`,
        alt: 'Куполите на Тадж Махал, Агра',
        width: 800,
        height: 1100,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/04_india_gate.webp`,
        alt: 'Портата на Индия (India Gate), Ню Делхи',
        width: 800,
        height: 1100,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/07_qutub_minar.webp`,
        alt: 'Кутуб Минар, Ню Делхи',
        width: 800,
        height: 1100,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/02_rickshaws_sunset.webp`,
        alt: 'Рикши по залез в Индия',
        width: 800,
        height: 1100,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/05_hawa_mahal_horses.webp`,
        alt: 'Хава Махал - Дворецът на ветровете, Джайпур',
        width: 1600,
        height: 1067,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/11_block_printing_woman.webp`,
        alt: 'Традиционен блокпечат с местна жена в Багру',
        width: 800,
        height: 1100,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/06_stepwell.webp`,
        alt: 'Стъпаловиден кладенец в Раджастан',
        width: 1600,
        height: 1067,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/03_henna_hand.webp`,
        alt: 'Рисуване с къна',
        width: 800,
        height: 1100,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/01_jahangiri_arch_interior.webp`,
        alt: 'Арка в Джахангири Махал, Агра Форт',
        width: 800,
        height: 1100,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/10_jahangiri_mahal_fort.webp`,
        alt: 'Джахангири Махал, Агра Форт',
        width: 1600,
        height: 901,
      },
      {
        src: `${AMELIA_INDIA_ASSET_BASE}/gallery/09_varanasi_ghats.webp`,
        alt: 'Гхатите на Варанаси край Ганг',
        width: 1600,
        height: 1067,
      },
    ],
    gallerySubtitle: 'Северна Индия - от розовите улици на Джайпур до изгрева над Ганг',
    faq: {
      heading: 'Често задавани въпроси за пътуването до Индия',
      intro: 'Практична информация преди да потеглиш за Северна Индия.',
      items: [
        {
          question: 'Какво прави това пътуване „само за жени“ и кой ще води групата?',
          answer: [
            'За нас разликата е преди всичко в атмосферата. Някои идват сами, други с приятелка, а след няколко дни вече сме компания от жени с общи интереси, избрали да преживеят точно тази дестинация заедно.',
            'Има неща, които друга жена разбира без обяснение - че си уморена, че днес просто искаш да си починеш в свободния следобед, че ти се говори за неща, които може би не би споделила в смесена група. И че, разбира се, ти трябва поне една свястна снимка.',
            'От София тръгвате заедно с представителка на Amelia Travel, а в Индия към групата се присъединява местна екскурзоводка, която познава страната отвъд туристическите маршрути.',
            'Единственото изключение са шофьорите на местния транспорт, които може да са мъже. Те са опитни и проверени професионалисти, но не са част от екипа, с който прекарвате дните си.',
            'Ако не си сигурна дали това е твоето пътуване, пиши ни. Ще го обсъдим.',
          ],
        },
        ...
        {
          question: 'Безопасно ли е да пътувам до Индия като жена?',
          answer: [
            'Да – и това е един от въпросите, заради които създадохме тази програма по този начин.',
            'Пътуваме в малка група жени, с представителка от Amelia Travel, която е с нас през цялото пътуване, и с местни водачи по маршрута. Транспортът е организиран от начало до край, а местният ни екип познава добре местата, през които ще преминаваме.',
            'Индия все пак е различна от Европа. Ще се обличаме по-скромно, ще внимаваме с вещите си и ще следваме препоръките на местния екип – същото, което бихме правили навсякъде, когато пътуваме.',
            'Ще има и моменти за самостоятелни разходки, но никога няма да се налага да бъдеш сама, ако не искаш.',
          ],
        },
        {
          question: 'Какъв е размерът на групата?',
          answer: [
            'Групата е до 16 жени, плюс представителка от Amelia Travel.',
            'Малката група не е случайна. С шестнайсет души се влиза в тесните улички на Стария Делхи, сяда се около една маса и се качва на една лодка. С четирийсет – не.',
          ],
        },
        {
          question: 'Подходящо ли е това пътуване, ако никога не съм била в Индия?',
          answer: [
            'Да. Програмата е създадена като първа среща със Северна Индия, но без да се опитваме да поберем цялата страна в две седмици.',
            'Ще видим Делхи, Джайпур, Агра и Варанаси – четири места с напълно различен характер. Ще имаме и големите забележителности, заради които идваш за първи път, и преживяванията между тях: блокпечат с местни жени, къна, кулинарна демонстрация, разходки с рикша и лодка по Ганг.',
            'Индия може да бъде интензивна. Затова не сме направили програма, в която просто тичаме от едно място към следващото.',
          ],
        },
        {
          question: 'Натоварена ли е програмата?',
          answer: [
            'Да, има дни с повече ходене, ранни сутрини и по-дълги трансфери. Все пак за 14 дни искаме да видим четири различни лица на Северна Индия.',
            'Но програмата има и по-бавни моменти – сутрешна йога, лодка по Ганг, свободна вечер във Варанаси, кулинарна вечер в Джайпур.',
            'Това не е почивка, в която прекарваш половината ден край басейна. Това е пътуване, в което си навън и преживяваш мястото.',
          ],
        },
        {
          question: 'Кога е най-подходящо да се пътува до Северна Индия?',
          answer: [
            'Пътуваме в края на по-хладния и сух сезон, който обикновено се смята за един от най-подходящите периоди за Северна Индия.',
            'През деня температурите обикновено са приятни за разглеждане, а сутрините и вечерите могат да бъдат прохладни. Особено рано сутрин, когато излизаме на лодка във Варанаси, ще оцениш нещо топло върху себе си.',
            'Затова: леки дрехи за деня, нещо с дълъг ръкав и един по-топъл слой за ранните сутрини.',
          ],
        },
        {
          question: 'Какво да облека в Индия?',
          answer: [
            'Не е необходимо да носиш традиционно индийско облекло. Леките и свободни дрехи са най-практичният избор.',
            'При посещенията на храмове и религиозни места е добре раменете и коленете да бъдат покрити. На някои места ще трябва да събуем обувките си, затова обувките, които се свалят лесно, са добра идея.',
            'И удобни обувки. Ще ни трябват.',
          ],
        },
        {
          question: 'Ще споделям ли стая?',
          answer: [
            'Цената е на човек в двойна стая.',
            'Ако пътуваш сама, ще те настаним с друга пътничка от групата – така всъщност се запознават много от хората при нас.',
            'Ако предпочиташ да имаш стаята за себе си, можеш да избереш единично настаняване срещу доплащане. Кажи ни при резервацията.',
          ],
        },
        {
          question: 'Трябва ли ми адаптер за контактите?',
          answer: [
            'Да, препоръчваме да си вземеш универсален адаптер. В Индия напрежението е 230 V, както в България, така че не ти трябва трансформатор, но контактите са различни.',
            'Нашите щепсели с две кръгли пина често влизат, но не във всички контакти и не винаги стабилно. Универсален адаптер с няколко входа е най-сигурният избор, а ако носиш няколко устройства, вземи и разклонител.',
          ],
        },
        {
          question: 'Може ли да се пие вода от чешмата?',
          answer: [
            'Не. В Индия водата от чешмата не е питейна, дори за чистене на зъби е по-добре да ползваш бутилирана.',
          ],
        },
        {
          question: 'Каква храна да очаквам и съобразявате ли се с хранителни режими?',
          answer: [
            'По този маршрут ще опиташ вкусовете на Северна Индия: топли лепешки (наан, роти, парата), леща (дал), сирене панир, зеленчукови къри и сладкиши като джалеби и кулфи. В Раджастан кухнята е по-наситена и е известна с ястия като дал баати чурма, а в Агра ще срещнеш и следи от могълската кухня. Във Варанаси храната е предимно вегетарианска и е част от местния начин на живот. Не всичко е люто, а можеш да поискаш по-слабо лютиво.',
            'Вегетарианските ястия са навсякъде, така че вегетарианките нямат проблем. Веганските и безглутеновите варианти също се намират, но изборът е по-малък и изискват предварителна уговорка. Съобразяваме се с хранителни режими и алергии: кажи ни при записването и ще го предадем на водача и на местния партньор.',
          ],
        },
        {
          question: 'Ами тоалетните по пътя?',
          answer: [
            'В хотелите и ресторантите всичко е както го очакваш.',
            'По маршрута обаче има дълги преходи с кола и седемчасово пътуване с влак, така че ще спираме на места, където понякога тоалетната е индийски тип – без седалка.',
            'Нашият съвет е прост: влажни кърпички, дезинфектант и малко тоалетна хартия в раницата.',
          ],
        },
        {
          question: 'Какво да очаквам от Варанаси?',
          answer: [
            'Варанаси вероятно ще бъде най-интензивната част от пътуването.',
            'Това е град, в който религията не е отделена от ежедневието. Ще видим хора, които се къпят и молят в Ганг, вечерната церемония аарти, тесните улички на Стария град и кремационните гхати.',
            'Тази част от програмата не е за всеки и предпочитаме да го кажем честно. Няма да се опитваме да направим Варанаси по-удобен или по-красив, отколкото е. Ще го видим такъв, какъвто е.',
          ],
        },
        {
          question: 'Ще видим ли кремация във Варанаси?',
          answer: [
            'Възможно е.',
            'Кремационните церемонии са част от ежедневието на града и са дълбоко свързани с индуистките вярвания.',
            'Ще преминаваме през тези места с уважение към хората и техните ритуали. В зоните на кремация снимането не е позволено.',
          ],
        },
        {
          question: 'Какво представлява разходката с лодка по Ганг?',
          answer: [
            'Ще имаме две много различни срещи с реката.',
            'Вечерта ще се качим на лодка, за да наблюдаваме церемонията Ганга Аарти (Ganga Aarti) от водата – огън, камбани, песнопения и стотици хора, събрани по гхатите.',
            'На следващата сутрин ще излезем отново с лодка, този път преди изгрев. Ще гледаме как Варанаси постепенно се събужда, докато слънцето изгрява над Ганг.',
          ],
        },
        {
          question: 'Какво представлява пътуването с влак от Агра до Варанаси?',
          answer: [
            'Влакът тръгва рано сутринта и пътуването продължава около седем часа.',
            'Ще пътуваме с климатизиран вагон и ще гледаме как Индия минава покрай прозореца – полета, села, малки гари, хора по пероните.',
            'Това е част от преживяването, а не просто начин да стигнем от Агра до Варанаси.',
          ],
        },
        {
          question: 'Ще имаме ли свободно време?',
          answer: [
            'Да, но това е организирано пътуване и програмата е сравнително наситена.',
            'Ще имаме моменти за кафе, пазаруване, самостоятелна разходка или просто почивка. Вечерта след пристигането във Варанаси например остава свободна, а последната ни вечер в Ню Делхи е по-спокойна.',
          ],
        },
        {
          question: 'Ще мога ли да пазарувам?',
          answer: [
            'Определено.',
            'В Делхи ще имаме възможност да разгледаме Janpath Market и пазарите на Стария Делхи. Джайпур е известен с текстилите, бижутата и занаятите си, а в Багру ще видим отблизо традиционния ръчен блокпечат.',
            'И ако си тръгнеш с повече шалове, бижута и дребни съкровища, отколкото си планирала – няма да сме изненадани.',
          ],
        },
        {
          question: 'Пари, карти и бакшиши?',
          answer: [
            'Валутата е индийска рупия.',
            'В хотели, по-големи ресторанти и магазини обикновено можеш да плащаш с карта, но на пазарите, при рикшите и в малките магазинчета ще ти трябва кеш. Затова е добре винаги да имаш малко рупии и дребни банкноти под ръка.',
            'Бакшишите са обичайна част от туристическите услуги в Индия. Ще ти кажем какви суми са подходящи за водачи, шофьори и други услуги, за да не се чудиш всеки път.',
          ],
        },
        {
          question: 'Нужна ли ми е виза?',
          answer: [
            'Да. За пътуването до Индия ще ти е необходима виза.',
            'Преди отпътуването ще ти изпратим информация кога и как се кандидатства и какви документи са необходими.',
          ],
        },
        {
          question: 'Нужно ли е да имам предишен опит с групови пътувания?',
          answer: [
            'Не.',
            'Не е необходимо да си била в Азия, да си пътувала сама или да си ходила на подобна организирана програма.',
            'По-важното е да си любопитна и да имаш готовност да приемеш, че Индия няма да се случва точно по европейския начин.',
            'Ще има шум, трафик, тълпи, крави по улиците, ранни сутрини и моменти, в които планът може да се промени.',
            'И точно това е част от пътуването.',
          ],
        },
      ],
    },
    ...
    seo: {
      title: 'Северна Индия отблизо | Amelia Travel',
      description:
        '14-дневно пътуване в Северна Индия: Ню Делхи, Джайпур, Агра и Варанаси - Тадж Махал, Чанд Баори, аарти на Ганг и блокпечат с жените от Багру.',
    },
    source: {
      legacyUrl: 'https://ameliatravel.bg/tour-item/india-tour/',
    },
    departureReturn: {
      departure: 'Летище София',
      return: 'Летище София',
