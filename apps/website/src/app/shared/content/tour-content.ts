    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: [
            'Не. В Киргизстан напрежението е 220 V, а контактите са същите като в България, така че си носиш обичайните зарядни. В юртите и по-отдалечените места токът е ограничен или липсва през част от деня, затова вземи външна батерия.',
          ],
        },
        {
        ...
        },
        {
          ...
          answer: [
            'Киргизката кухня е изградена върху месо, тесто и мляко. Ще опиташ лагман (ръчно направени фиде със зеленчуци и месо), плов, манты, самса и бешбармак, традиционното ястие с месо и фиде. Хлябът е пресен и вкусен, а към чая ще получаваш конфитюри, мед, ядки и кисело мляко. Ако искаш да опиташ, има и кумис, ферментирало кобилешко мляко, който е специфичен на вкус.',
            'Храненето е включено според програмата, а всичко, което не е изрично посочено, е за твоя сметка. Съобразяваме се с хранителни режими и алергии: вегетарианските варианти (супи, салати, тестени изделия, яйца) се намират, но изборът е по-малък, особено в юртите и селата. За веганци и хора с алергии е по-трудно, затова ни кажи при записването и ще го уточним с местния партньор.',
          ],
        },
        {
        ...
        },
        {
          ...
          answer: [
            'През юни и юли дните в долините и край Исък-Кул са топли, но вечер и на височина (например при юртите) е доста студено, понякога близо до нулата. Обличай се на пластове:',
          ],
          bullets: [
            'удобни, здрави обувки за ходене и за неравен терен;',
            'топъл пуловер или поларен и лека непромокаема яке, защото времето в планината се сменя бързо;',
