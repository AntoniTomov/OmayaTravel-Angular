  ...
  return {
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            'Кога е най-подходящо да се пътува до Северна Индия и какво е времето през март?',
          answer: [
        ...
        {
          question: 'Ами прословутият индийски стомах?',
          answer: [
            'Най-често се минава с малко внимание и нищо повече.',
            'Пием бутилирана вода и я използваме и за миене на зъбите. Избираме храна, която е добре сготвена и сервирана топла, внимаваме с леда и със суровите храни на места, за които не сме сигурни.',
            'В хотелите и ресторантите по програмата ще имаме достъп до подходящи условия за хранене.',
            'За лекарства, ваксини и други здравни въпроси най-добре се консултирай с личния си лекар или кабинет по пътническа медицина преди пътуването.',
          ],
        },
        {
